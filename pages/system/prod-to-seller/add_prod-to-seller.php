                ...
                if($sql_add_removals_resultado){
                  ...
                  if($sql_del_removals_has_products_has_sizes_resultado){
                    ...
                    if($sql_alt_inventories_resultado){
                      $msg = "Registro de repasse de mercadorias para vendedores cadastrado com sucesso!";
                    }else{
                      $msg = "Erro ao efetuar cadastro de repasse de mercadorias para vendedores. [erro 03]";
                    }
                  }else{
                    $msg = "Erro ao efetuar cadastro de repasse de mercadorias para vendedores. [erro 02]";
                  }
                }else{
                  $msg = "Erro ao efetuar cadastro de repasse de mercadorias para vendedores. [erro 01]";
                }
              }else if($quantity=='0'){
                $tabela = "removals";
                $dados = array(
                ...
                if($sql_add_removals_resultado){
                  ...
                  if($sql_del_removals_has_products_has_sizes_resultado){
                    ...
                    if($sql_del_inventories_resultado){
                      ...
                      $msg =  "Erro ao efetuar cadastro de repasse de mercadorias para vendedores. [erro 04]";
                    }
                  }else{
                    $msg =  "Erro ao efetuar cadastro de repasse de mercadorias para vendedores. [erro 05]";
                  }
                }else{
                  $msg =  "Erro ao efetuar cadastro de repasse de mercadorias para vendedores. [erro 06]";
                }
              }else if($quantity < '0'){
