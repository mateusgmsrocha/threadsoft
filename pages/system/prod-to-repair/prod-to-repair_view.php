<div id="contentHistory">
  ...
  ?>
  <h1><a href="?folder=system/prod-to-repair/&file=prod-to-repair_history&ext=php" class='backalt'><i class="fa fa-arrow-circle-left" aria-hidden="true"></i></a> Repasse de Conserto
    (
      <?php
        echo $sql_sel_removals_dados['name'];
      ?>
    ): <?php echo $sql_sel_removals_dados['date'] ?> - <?php echo $sql_sel_removals_dados['hour'] ?></h1> <br>  <div class="historyTable historyView">
    <table>
      <?php
