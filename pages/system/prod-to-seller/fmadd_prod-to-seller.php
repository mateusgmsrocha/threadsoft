...
<form action="?folder=system/prod-to-seller/&file=add_prod-to-seller&ext=php" method="post" onsubmit="return validaDetalhe()">
  <div id="contentHistory">
    <h1>Repasse de Mercadorias para Vendedores</h1><br>
        ...
        <tbody>
          <tr class="linhas" id="id__0">
            <td>
              ...
              ?>
              <select name="selfabricante[]" id="selfabricante" onChange="mostrarCodigoRepasse(this)">
