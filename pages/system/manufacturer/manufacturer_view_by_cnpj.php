<div id="contentHistory">
  ...
  <div class="historyFilters filterdisplay filterdisplay">
  ...
  <div class="historyTable historyBroken">
    <?php
      $p_cnpj = $_POST['searchcnpj'];
      $sql_sel_manufacturers = "SELECT id, name, phone, email, cnpj FROM manufacturers WHERE cnpj LIKE '%".$p_cnpj."%'";
