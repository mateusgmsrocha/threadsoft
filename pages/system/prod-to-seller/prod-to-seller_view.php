<div id="contentHistory">
  ...
  ?>
  <h1><a href="?folder=system/prod-to-seller/&file=prod-to-seller_history&ext=php" class='backalt'><i class="fa fa-arrow-circle-left" aria-hidden="true"></i></a> Repasse
    (
    <?php
    ...
    ?>
    ): <?php echo $sql_sel_removals_dados['date'] ?> - <?php echo $sql_sel_removals_dados['hour'] ?></h1> <br>
